        ...
        document.getElementById(`card${i}`).addEventListener("click", () => {
            ...
            if (i === 4) {
                ...
                document.getElementById("next-text-button").addEventListener("click", () => { 
                    ...
                    document.getElementById("text-card4-2").innerText = "• עקרון השכפול- עם העובד עושה משהו טוב בחלקה אפשר לשכפל את העוצמה שלו לתחום אחר.";
                    } else if (next === 2){
                       ...
                       document.getElementById("text-card4-2").innerText = "• עקרון שימור הידע- מבקשים מהעובד להעלות על כתב כיצד הוא משיג את התוצאות שהוא משיג. מפיצים מסמך זה בארגון. במחלקה"
